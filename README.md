...
- "mode" controls what type of teams the builder will create.  Current options are balance, offense, and stall, although gen8anythinggoes only works for balance.
